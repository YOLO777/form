      ...
      handleWidgetAdd (evt) {
        ...
        if (this.data.list[newIndex].type === 'table') {
          this.$set(this.data.list, newIndex, {
            ...
            options: {
              ...this.data.list[newIndex].options,
              tableData: this.data.list[newIndex].options.tableData.map(item => ({
                ...item
              })),
              tablePropData: this.data.list[newIndex].options.tablePropData.map(item => ({
                ...item
              })),
            }
          })
      ...
      handleWidgetColAdd ($event, row, colIndex) {
        ...
        if (row.columns[colIndex].list[newIndex].type === 'table') {
          this.$set(row.columns[colIndex].list, newIndex, {
            ...
            options: {
              ...row.columns[colIndex].list[newIndex].options,
              tableData: row.columns[colIndex].list[newIndex].options.tableData.map(item => ({
                ...item
              })),
              tablePropData: row.columns[colIndex].list[newIndex].options.tablePropData.map(item1 => ({
                ...item1
              })),
            }
          })
