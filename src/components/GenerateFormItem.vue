  ...
  <el-form-item :label="widget.name" :prop="widget.model">
    ...
    <template v-if="widget.type == 'table'">
      <fm-table
        ...
        :width="widget.options.width"
        :height="widget.options.height"
        :tableData="widget.options.tableData"
        :tablePropData="widget.options.tablePropData">
      </fm-table>
    </template>
...
<script>
  import FmUpload from './Upload/index'
  import FmEditor from './Editor/tinymce'
  import FmUploadFiles from './UploadFiles/index'
  import FmTable from './Table/index'
  ...
  export default {
    ...
    created() {
      ...
      if (this.widget.type == 'table') {
        //赋值table数据
        this.widget.options.tableData=this.models[this.widget.model];
      }
    },
    methods: {},
    watch: {
