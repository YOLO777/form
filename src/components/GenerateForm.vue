<template>
  <div>
    <el-form ref="generateForm" :disabled="uneditable"
      ...
      <el-button  type="primary"　style="display:none;" @click="getValue()">确 定</el-button>
    </el-form>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    props: ['data', 'remote', 'value', 'insite', 'uneditable'],
    data () {
      return {
        models: {},
        rules: {}
    ...
    methods: {
      ...
      getValue() {
        ...
        const params = { models: this.models, checkedFlg: checkFlg };
        console.log("GenerateForm");
        console.log(this.models);
        // 向父组件传值
        this.$emit('modelsChanged', params);
      }
    },
    watch: {
      value: {
